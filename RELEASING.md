...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_bouckaert_et_al2018.py --with-zenodo --with-cldfreadme
  ```
...
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_bouckaert_et_al2018.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_bouckaert_et_al2018.py vX.Y
  ```
